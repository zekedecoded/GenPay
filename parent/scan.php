...
// Last 5 scan-and-pay purchases from this parent's own wallet, with the
// merchant's public label (stall name, falling back to the account name).
$recentPayments = [];
        ...
        <div class="parent-content" style="max-width:none;">
            ...
            <section class="sd-panel sp-recent">
                <div class="sd-panel-head">
                    ...
                    <a href="<?= PARENT_URL ?>/activity.php" class="sd-viewall">View All</a>
                </div>
...
const VALIDATE_API = "<?= PARENT_URL ?>/api/validate_qr.php";
const PAY_API = "<?= PARENT_URL ?>/pay_qr.php";
...
async function payNow() {
    ...
    // invalid_code, out_of_stock… Terminal ones close the door on retrying
    // the same code.
