...
$PHPMAILER_LANG['buggy_php'] =
  'Versiunea instalată de PHP este afectată de o problemă care poate duce la coruperea mesajelor Pentru a preveni această problemă, folosiți SMTP, dezactivați opțiunea mail.add_x_header din php.ini, folosiți MacOS/Linux sau actualizați versiunea de PHP la 7.0.17+ sau 7.1.3+.';
$PHPMAILER_LANG['connect_host'] =
  'Eroare SMTP: Conectarea la serverul SMTP a eșuat.';
$PHPMAILER_LANG['data_not_accepted'] =
  'Eroare SMTP: Datele nu au fost acceptate.';
...
$PHPMAILER_LANG['file_open'] =
  'Eroare fișier: Nu se poate deschide următorul fișier: ';
...
$PHPMAILER_LANG['invalid_header'] =
  'Numele sau valoarea header-ului nu este validă: ';
...
$PHPMAILER_LANG['provide_address'] =
  'Trebuie să adăugați cel puțin o adresă de email.';
$PHPMAILER_LANG['recipients_failed'] =
  'Eroare SMTP: Următoarele adrese de email au eșuat: ';
