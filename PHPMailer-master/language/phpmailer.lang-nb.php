...
$PHPMAILER_LANG['buggy_php'] =
  'Din versjon av PHP er berørt av en feil som kan føre til ødelagte meldinger. For å løse problemet kan du bytte til SMTP, deaktivere alternativet mail.add_x_header i php.ini, bytte til MacOS eller Linux eller oppgradere PHP til versjon 7.0.17+ eller 7.1.3+.';
...
$PHPMAILER_LANG['provide_address'] =
  'Du må oppgi minst én mottaker-e-postadresse.';
$PHPMAILER_LANG['recipients_failed'] =
  'SMTP Feil: Følgende mottakeradresse feilet: ';
...
$PHPMAILER_LANG['variable_set'] =
  'Kan ikke angi eller tilbakestille variabel: ';
