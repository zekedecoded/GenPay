...
<head>
    ...
    <title>Merchant Onboarding | GenPay</title>
    ...
    <link rel="stylesheet" href="<?= CSS_URL ?>/merchant_onboarding.css?v=4">
</head>
<body class="gp-theme">
        ...
        <section class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-4 col-xl-2">
                <div class="metric-card" style="padding:16px;border-top:3px solid <?= $stageColors[$key] ?>">
                    <span style="font-size:11px;color:var(--gp-muted)"><?= $stageLabels[$key] ?></span>
